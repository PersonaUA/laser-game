import{S as e}from"./index-CLebcSFI.js";import"./oitFragment-1oDe6dtS.js";import"./harmonicsFunctions-B1CD8Lmk.js";import"./mainUVVaryingDeclaration-LG9Ngg4y.js";import"./imageProcessingFunctions-B_D_1mea.js";import"./logDepthDeclaration-Cv01jz1T.js";import"./fogFragment-OLNWwPGk.js";import"./pbrBRDFFunctions-YhKELRGa.js";import"./logDepthFragment-Dhml0JRM.js";const n="pbrFragmentDeclaration",V=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=H);const r="samplerFragmentAlternateDeclaration",x=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=x);const o="pbrFragmentSamplersDeclaration",W=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=W);const t="subSurfaceScatteringFunctions",X=`bool testLightingForSSS(float diffusionProfile)
...
#endif
}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=z);const s="hdrFilteringFunctions",K=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=q);const C="pbrBlockAlbedoOpacity",Z=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Z);const u="pbrBlockReflectivity",J=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=J);const S="pbrBlockAmbientOcclusion",j=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
return outParams;}
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=ae);const T="pbrBlockIridescence",re=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=re);const O="pbrBlockSubSurface",oe=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=oe);const p="pbrBlockNormalGeometric",te=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=te);const L="pbrBlockNormalFinal",fe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=fe);const g="pbrBlockLightmapInit",ce=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=ce);const M="pbrBlockGeometryInfo",le=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=le);const D="pbrBlockReflectance0",de=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=de);const _="pbrBlockReflectance",se=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=se);const h="pbrBlockDirectLighting",Ee=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Re);const P="pbrBlockFinalUnlitComponents",Ce=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Ce);const U="pbrBlockFinalColorComposition",ue=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=ue);const b="pbrBlockImageProcessing",Se=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=me);const i="pbrPixelShader",y=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=y);const De={name:i,shader:y};export{De as pbrPixelShader};
