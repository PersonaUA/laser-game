import{S as e}from"./index-CLebcSFI.js";import"./oitFragment-4XwQ7Ch2.js";import"./harmonicsFunctions-BC_oeaUC.js";import"./mainUVVaryingDeclaration-CPUQOt-c.js";import"./bumpFragment-DBsNomlX.js";import"./imageProcessingFunctions-B80KHUpf.js";import"./clipPlaneFragment-DDRWNkOF.js";import"./logDepthDeclaration-CTk6Okea.js";import"./fogFragment-Bj0l6VBp.js";import"./helperFunctions-B75S2OTj.js";import"./pbrBRDFFunctions-BW1ZDEeT.js";import"./logDepthFragment-CbZFCCge.js";import"./sceneUboDeclaration-Dk7iNKTQ.js";const i="pbrFragmentExtraDeclaration",y=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=y);const a="samplerFragmentAlternateDeclaration",x=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=x);const n="pbrFragmentSamplersDeclaration",V=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=V);const f="subSurfaceScatteringFunctions",H=`fn testLightingForSSS(diffusionProfile: f32)->bool
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=W);const o="pbrHelperFunctions",X=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=X);const c="pbrDirectLightingSetupFunctions",w=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=w);const l="pbrDirectLightingFalloffFunctions",k=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=k);const d="hdrFilteringFunctions",Y=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=Y);const s="pbrDirectLightingFunctions",z=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=K);const m="pbrBlockAlbedoOpacity",$=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=$);const S="pbrBlockReflectivity",q=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=q);const v="pbrBlockAmbientOcclusion",Z=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=Z);const u="pbrBlockAlphaFresnel",j=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=j);const R="pbrBlockAnisotropic",J=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=J);const p="pbrBlockReflection",Q=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Q);const C="pbrBlockSheen",ee=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=ee);const A="pbrBlockClearcoat",re=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=re);const I="pbrBlockIridescence",ie=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=ie);const N="pbrBlockSubSurface",ae=`struct subSurfaceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=ne);const T="pbrBlockNormalFinal",fe=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=fe);const L="pbrBlockLightmapInit",te=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=te);const g="pbrBlockGeometryInfo",oe=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=oe);const M="pbrBlockReflectance0",ce=`var reflectance: f32=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);var specularEnvironmentR0: vec3f=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=ce);const h="pbrBlockReflectance",le=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=le);const _="pbrBlockDirectLighting",de=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=de);const D="pbrBlockFinalLitComponents",se=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=se);const F="pbrBlockFinalUnlitComponents",Ee=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=Ee);const P="pbrBlockFinalColorComposition",me=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=me);const U="pbrBlockImageProcessing",Se=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=Se);const b="pbrBlockPrePass",ve=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=ve);const G="pbrDebug",ue=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=ue);const r="pbrPixelShader",B=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=B);const De={name:r,shader:B};export{De as pbrPixelShaderWGSL};
