import{S as e}from"./index-CLebcSFI.js";const o="decalFragmentDeclaration",v=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=v);const i="prePassDeclaration",p=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=p);const t="oitDeclaration",u=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=u);const a="lightFragmentDeclaration",S=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=S);const r="lightUboDeclaration",m=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=g);const n="shadowsFragmentFunctions",w=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=w);const d="reflectionFunction",X=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=X);const l="decalFragment",D=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);const h="depthPrePass",x=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=x);const f="lightFragment",L=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=L);const c="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
